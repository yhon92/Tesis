...
<head>
    ...
    <script>
        ...
        window.onload = function(){
            var lista = document.getElementById("catedra");
            lista.onchange = codigoAsignaciones;

            function codigoAsignaciones(){
                var cod = lista.value;
                document.impirmir_reporte.codigoCatedra.value= cod;
                cargarContenido('ver_catedra_datagrid.php','contenido',cod);
                // alert(cod);
            }
        }
    </script>
    ...
    <article id="contenedor-principal">
        <section id="contenedor-actividad">
            ...
            <div id="contenedor-datagrid">
                ...
                <div>
                    <form id"reporte_form" class="center" name="impirmir_reporte" method="post" target="_blank" action="reporte_catedra.php">
                        <input type="hidden" name="codigoCatedra">
